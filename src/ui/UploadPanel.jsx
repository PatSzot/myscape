...
const s = {
  ...
  addMoreLabel: { flex: 1, fontSize: 15, fontWeight: 500, color: '#000', letterSpacing: '-0.01em', fontFamily: HEADLINE },
  ...
  mainLabel: { fontSize: 17, fontWeight: 500, color: '#000', letterSpacing: '-0.01em', fontFamily: HEADLINE },
